    ...
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)] bg-gradient-to-b from-teal-50 to-white dark:from-gray-900 dark:to-gray-800">
      <main className="flex flex-col gap-[32px] row-start-2 items-center sm:items-start max-w-4xl">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-teal-500 inline-block text-transparent bg-clip-text dark:from-blue-400 dark:to-teal-300 relative">
            Health Weave
            <span className="absolute -top-1 -left-1 w-2 h-2 bg-blue-400 rounded-full animate-pulse"></span>
            <span className="absolute -top-1 -right-1 w-2 h-2 bg-teal-400 rounded-full animate-pulse"></span>
            <span className="absolute -bottom-1 -left-1 w-2 h-2 bg-teal-400 rounded-full animate-pulse"></span>
            <span className="absolute -bottom-1 -right-1 w-2 h-2 bg-blue-400 rounded-full animate-pulse"></span>
          </h1>
        </div>

        <div className="text-center sm:text-left mb-6">
          <h2 className="text-5xl font-bold mb-4 text-gray-800 dark:text-white leading-tight">
            Personalized{" "}
            <span className="text-blue-600 dark:text-blue-400">Treatment</span>{" "}
            <span className="text-teal-600 dark:text-teal-400">
              Optimization
            </span>
          </h2>
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl">
            Our AI platform predicts individual patient responses to different
            treatment options based on their unique characteristics, improving
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mb-8">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md border border-teal-100 dark:border-gray-700 hover:shadow-lg transition-all duration-300 hover:border-teal-200 dark:hover:border-teal-800">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Comprehensive analysis of patient data including medical history,
              genetics, and lifestyle factors to create personalized treatment
              profiles.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md border border-blue-100 dark:border-gray-700 hover:shadow-lg transition-all duration-300 hover:border-blue-200 dark:hover:border-blue-800">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Advanced machine learning algorithms predict treatment efficacy
              and potential side effects based on individual patient
              characteristics.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md border border-green-100 dark:border-gray-700 hover:shadow-lg transition-all duration-300 hover:border-green-200 dark:hover:border-green-800">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Real-time monitoring and adjustment of treatment plans based on
              patient response data, ensuring optimal healthcare outcomes.
            </p>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-md border border-blue-100 dark:border-gray-700 w-full">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                93% improvement in treatment efficacy
              </p>
            </div>
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                78% reduction in adverse effects
              </p>
            </div>
            <div className="flex items-start gap-3">
